...
public interface SysKB extends DataRepresentation {
    void reinit();
    ExecutionEnvironment getSystemExecutionEnvironment();
    String getSystemName();
    LogMessageType getSystemLoggerMessageType();
    Logger getSystemLogger();
    Logger createSystemLogger();
    Boolean isSystemInTestMode();
}